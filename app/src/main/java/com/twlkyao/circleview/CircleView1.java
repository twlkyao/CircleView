package com.twlkyao.circleview;
...
public class CircleView1 extends View {
    ...
    public CircleView1(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a= context.obtainStyledAttributes(attrs, R.styleable.CircleView1);
//        the styleable name diviede by underline.
        mColor = a.getColor(R.styleable.CircleView1_circleColor, Color.GREEN);
        a.recycle();
        init();
    }
